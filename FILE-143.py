...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mTONU\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .Tonu1.txt')
    os.system('rm -rf .Tonu2.txt')
...
def create_file():
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mTonu\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
    ...
    version()
if not os.path.exists(".Tonuwork.txt"):
	open(".Tonuwork.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
...
\033[1;32m│\033[1;31m➣\033[1;37m YOUTUBE \033[1;31m:\033[1;32m BD-TERMUX │\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36m200Bd \033[1;37m•   \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
